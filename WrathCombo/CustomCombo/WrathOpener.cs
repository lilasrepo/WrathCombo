...
public abstract class WrathOpener
{
    ...
    // refresh 2026-07-29: upstream moved to Svc.PlayerState.EffectiveLevel, which this
    // walk-back ECommons does not expose (no PlayerState service). Kept on Player.Level,
    // the form TC has always shipped. Difference is level-sync awareness in opener gating;
    // revisit if the ECommons walk-back ever gains PlayerState.
